...
var require_longFormatters = __commonJS({
  "node_modules/date-fns/_lib/format/longFormatters/index.js"(exports, module) {
    ...
    var dateLongFormatter3 = function dateLongFormatter4(pattern, formatLong) {
      switch (pattern) {
        case "P":
    ...
    var timeLongFormatter3 = function timeLongFormatter4(pattern, formatLong) {
      switch (pattern) {
        case "p":
    ...
    var dateTimeLongFormatter3 = function dateTimeLongFormatter4(pattern, formatLong) {
      var matchResult = pattern.match(/(P+)(p+)?/) || [];
      var datePattern = matchResult[1];
      var timePattern = matchResult[2];
      if (!timePattern) {
        return dateLongFormatter3(pattern, formatLong);
      }
      var dateTimeFormat;
      switch (datePattern) {
        case "P":
      ...
      return dateTimeFormat.replace("{{date}}", dateLongFormatter3(datePattern, formatLong)).replace("{{time}}", timeLongFormatter3(timePattern, formatLong));
    };
    var longFormatters4 = {
